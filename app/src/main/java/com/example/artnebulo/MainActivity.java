...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = findViewById(R.id.remove_book);
        button.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, RemoveBookActivity.class)));

        Button buttonn = findViewById(R.id.edit_book);
        buttonn.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, editBook.class)));
